...
Title                   : Rbots CTF
File Name               : rbots-ctf.zip
File Size               : 2.3Mb
Author(s)               : Raynar
			: Hell Raiser
Date of Release         : March 2002

Email Address           : raynar@gamebox.net
Misc. Author Info       : Visit the Rbots web site: http://rbots.massassi.net

Description             : Rbots Capture The Flag. A project to develop a working
                          bot for JK & MotS. This is the final release, due to
			  health reasons.There are still problems but all of
			  them are minor and should not stop you from playing.

Additional Credits to   : Hell Raiser, and everyone who answered questions or
                          replied with ideas. Also those who submitted code.

Alpha/Beta Testers      : IGx89, Goofz, A_C_1, kingofsuede, Infected, mscbuck
                          Jedi Howell, Nsinger998, James Bond & Hellcat

Development machine     : PIII/600E 256Mb TNT2-Ultra
Machine(s) tested on    : Celeron/333 64Mb S3 Trio
================================================================

* Play Information *

Episode name            : Rbots
Level name(s)           : The Duel
                          Arena of Light and Dark
                          Playable with No Force, Full Force & Sabers

JK version required     : Jedi Knight
...
Base                    : Levels converted from LEC default levels for use with Rbots
Editor(s) used          : JED v. 0.95
Known Bugs              : Plenty - refer to the 'rbots.txt' file and the Rbots website for details
...
You may distribute this level amongst your friends, but please do not
mirror these files on any other site apart from the main Rbots site.
